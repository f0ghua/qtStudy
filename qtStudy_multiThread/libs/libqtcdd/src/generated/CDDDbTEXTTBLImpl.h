#ifndef VECTOR_CDD_CDDDBTEXTTBLIMPL_H
#define VECTOR_CDD_CDDDBTEXTTBLIMPL_H
 ...
 *
 */
class VECTOR_CDD_API CDDDbTEXTTBLImpl
{
public:
    CDDDbTEXTTBLImpl();
    ~CDDDbTEXTTBLImpl();
    ...
    /** @element TEXTMAP */
    QVector<QSharedPointer<CDDDbTEXTMAP>> m_elTextmaps;
...
#endif // VECTOR_CDD_CDDDBTEXTTBLIMPL_H
