...
#ifndef F_NO_DEBUG
            QLOG_TRACE() << "FRControllerType::load, m_maxDynamicPayloadLength =" << m_maxDynamicPayloadLength;
#endif
        } else if (childElement.tagName() == "flexray:MAX-DYNAMIC-PAYLOAD-LENGTH") {
            m_maxDynamicPayloadLength = childElement.text().toUShort();
#ifndef F_NO_DEBUG
