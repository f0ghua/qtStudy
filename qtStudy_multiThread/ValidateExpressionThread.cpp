...
void ValidateExpressionThread::emitExpressionChanged(bool validExpression, bool validPointer, qint32 value)
{
    emit expressionChanged(validExpression, validPointer, value);
}

void ValidateExpressionThread::emitInstructionChanged(qint32 sizeDifference, QString error)
{
