...
#ifndef XMODBUSRTUCLIENT_P_H
#define XMODBUSRTUCLIENT_P_H
...
class XModbusRtuClientPrivate : public QModbusClientPrivate
{
    Q_DECLARE_PUBLIC(XModbusRtuClient)
    enum State {
        Idle,
        Schedule,
        Send,
...
public:
    ...
    */
    ...
    void setupEnvironment() {
        ...
        m_state = XModbusRtuClientPrivate::Idle;
    }
