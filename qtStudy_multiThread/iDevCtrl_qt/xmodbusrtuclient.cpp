...
/*!
    \class XModbusRtuClient
    \inmodule QtSerialBus
    \since 5.6

    \brief The XModbusRtuClient class represents a Modbus client
...
*/
XModbusRtuClient::XModbusRtuClient(QObject *parent)
    : QModbusClient(*new XModbusRtuClientPrivate, parent)
{
    Q_D(XModbusRtuClient);
    d->setupSerialPort();
}
...
/*!
    \internal
*/
XModbusRtuClient::~XModbusRtuClient()
{
    close();
}
...
*/
int XModbusRtuClient::interFrameDelay() const
{
    Q_D(const XModbusRtuClient);
...
*/
void XModbusRtuClient::setInterFrameDelay(int microseconds)
{
    Q_D(XModbusRtuClient);
...
/*!
    \internal
*/
XModbusRtuClient::XModbusRtuClient(XModbusRtuClientPrivate &dd, QObject *parent)
...
void XModbusRtuClient::close()
{
    ...
    while (!d->m_queue.isEmpty()) {
        ...
        XModbusRtuClientPrivate::QueueElement elem = d->m_queue.dequeue();
