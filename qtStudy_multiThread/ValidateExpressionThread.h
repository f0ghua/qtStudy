...
public:
    ...
    void start();
    void stop();
    void emitExpressionChanged(bool validExpression, bool validPointer, qint32 value);
    void emitInstructionChanged(qint32 sizeDifference, QString error);

signals:
    void expressionChanged(bool validExpression, bool validPointer, qint32 value);
    void instructionChanged(qint32 sizeDifference, QString error);
